...
import net.webpdf.wsclient.schema.operation.InitialViewType;
import net.webpdf.wsclient.schema.operation.MagnificationType;
 ...
 * display options of your PDF document using the SOAP API.
 */
...
public class ChangePdfDisplayOptions {
    ...
    public static void main(String... args) throws Exception {
        ...
        try (
            ...
            /** Initialize and add a toolbox options parameter root: */
            OptionsType options = new OptionsType();
            toolboxWebService.getOperationParameters().add(options);
