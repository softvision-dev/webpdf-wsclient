 ...
 * markup annotation to a PDF document using the SOAP API.
 */
...
public class AddAnnotationsToPdf {
    ...
    public static void main(String... args) throws Exception {
        ...
        try (
            ...
            toolboxWebService.getOperationParameters().add(annotation);
             ...
             */
            MarkupAnnotationType.Position position = new MarkupAnnotationType.Position();
            markup.setPosition(position);
            RectangleType rectangle = new RectangleType();
            position.getPathElementOrQuadrilateral().add(rectangle);
            rectangle.setX(15);
            rectangle.setY(20);
            rectangle.setWidth(80);
            rectangle.setHeight(14);
            rectangle.setCoordinates(CoordinatesType.USER);
            rectangle.setMetrics(MetricsType.PX);
