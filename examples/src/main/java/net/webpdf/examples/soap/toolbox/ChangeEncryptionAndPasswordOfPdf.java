...
import net.webpdf.wsclient.schema.operation.PdfEncryptionKeyType;
...
public class ChangeEncryptionAndPasswordOfPdf {
    ...
    public static void main(String... args) throws Exception {
        ...
        try (
            ...
            /** Initialize and add a toolbox security parameter root: */
            SecurityType security = new SecurityType();
            toolboxWebService.getOperationParameters().add(security);
