...
import net.webpdf.wsclient.openapi.OperationToolboxOptionsOptions;
...
public class ChangePdfDisplayOptions {
     ...
     * <li>The parameterization required to change the display options of a PDF document.</li>
    ...
    public static void main(String... args) throws Exception {
        ...
        try (
            ...
            OperationToolboxOptionsOptions options = new OperationToolboxOptionsOptions();
            toolboxOperation.setOptions(options);

            /**
             * Select the options you want to set for displaying readers.
             */
            options.setInitialPage(2);
            options.setInitialView(OperationToolboxOptionsOptions.InitialViewEnum.FULLSCREEN);
            options.setMagnification(OperationToolboxOptionsOptions.MagnificationEnum.ZOOM);
