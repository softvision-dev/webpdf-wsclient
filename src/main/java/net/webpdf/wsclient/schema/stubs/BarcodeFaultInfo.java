...
/**
 * <p>
 * An instance of {@link BarcodeFaultInfo} will be encountered in case the webPDF server´s response indicates the
...
public class BarcodeFaultInfo implements FaultInfo {
    @XmlElement(namespace = "http://schema.webpdf.de/1.0/soap/barcode")
