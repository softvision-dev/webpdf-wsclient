...
/**
 * <p>
 * An instance of {@link ToolboxFaultInfo} will be encountered in case the webPDF server´s response indicates the
...
public class ToolboxFaultInfo implements FaultInfo {
    @XmlElement(namespace = "http://schema.webpdf.de/1.0/soap/toolbox")
