...
/**
 * <p>
 * An instance of {@link URLConverterFaultInfo} will be encountered in case the webPDF server´s response indicates the
...
public class URLConverterFaultInfo implements FaultInfo {
    @XmlElement(namespace = "http://schema.webpdf.de/1.0/soap/urlconverter")
