...
public class SoapWebserviceFactoryTest {
    ...
    public void testFactoryCreateWebserviceInstance() throws Exception {
        ...
        Assert.assertNotNull("The signature webserivce should have been initialized.", signatureWebService);
    ...
    public void testNoOperationData() throws Exception {
        try (Session session = SessionFactory.createInstance(WebServiceProtocol.SOAP,
            ...
            Assert.assertEquals(String.format("Errorcode %s expected.", Error.INVALID_OPERATION_DATA.getCode()), ex.getResult().getCode(), Error.INVALID_OPERATION_DATA.getCode());
        }
    }
    ...
    public void testNoSession() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(String.format("Errorcode %s expected.", Error.SESSION_CREATE.getCode()), ex.getResult().getCode(), Error.SESSION_CREATE.getCode());
        }
    }
}
