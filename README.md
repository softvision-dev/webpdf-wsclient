...
## Changes
The current version 3.0.0 is optimized for webPDF version 9. When using webPDF 7 or 8 you might prefer the version 1.0.1 or 2.0.1 of this library.

Be aware, that the wsclient library version 3.0.0 is no longer compatible with code you might have developed using previous wsclient versions.
To enable you to extend and customize Document, DocumentManager and Session, parts of this library have been refactored and generalized, therefore some declarations and paths might have changed.
